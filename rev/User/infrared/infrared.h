...
#define REV_GPIO_PIN                	GPIO_PIN_0
#define REV_EXTI_IRQ                	EXTI0_IRQn
#define REV_IRQHandler                  EXTI0_IRQHandler//EXTI0_IRQn
...
/*******************************************************/				
#define INF_REV(x)					HAL_GPIO_WritePin(REV_GPIO_PORT,REV_GPIO_PIN,x)
